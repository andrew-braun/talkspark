...
| **Motion**        | `--motion-press`, `--motion-feedback`, `--motion-drop`, `--motion-split`, `--motion-expand`, `--motion-stagger`, `--motion-loader`, `--motion-reduced`, `--ease-spring`, `--ease-out` | Hero motion uses drop, split, expand, stagger, and loader timing with spring/out easing; supporting press and feedback motion stays brief, with a reduced-motion duration for accessibility                                                                           |
